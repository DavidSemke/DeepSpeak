...
import type { JoinedRoomDict, JoinedRoomDictValue } from "./types"

export function insertJoinedRoomKey(roomId: string, data: JoinedRoomDictValue) {
...
export function getJoinedRoomValue(roomId: string): JoinedRoomDictValue | null {
  const joinedRoomsJson = Cookies.get("joinedRooms")
